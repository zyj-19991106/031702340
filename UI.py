...
class food_interface():
    ...
    def click3(self):
        ...
        tree.insert("", "1",
                    values=("海底捞火锅(工业路苏宁广场店)", "苏宁广场 工业路233号苏宁广场5楼501", "五星", "1736", "123", "9.2", "9.2", "9.3"))
        tree.insert("", "1",
                    values=("左稻(融侨中心店)", "宝龙万象 江滨西大道100号融侨中心ARTMALL4楼", "五星", "1364", "181", "9.1", "9.3", "9.1"))
        tree.pack()
    ...
    def click4(self):
        ...
        tree.insert("", "1",
                    values=("埖绛法式日料花园餐厅", "	左海/西湖公园 西二环北路236号华侨新村28座内", "五星", "192", "263", "9.0", "9.3", "9.2"))
        tree.pack()
